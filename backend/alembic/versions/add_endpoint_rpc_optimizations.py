"""add_endpoint_rpc_optimizations

Revision ID: add_endpoint_rpc_optimizations
Revises: add_buddies_self_check
...
revision: str = "add_endpoint_rpc_optimizations"
down_revision: Union[str, None] = "add_buddies_self_check"
...
def downgrade() -> None:
    op.execute("DROP FUNCTION IF EXISTS public.get_user_profile_bundle(integer);")
    op.execute("DROP FUNCTION IF EXISTS public.list_buddies_for_user(integer, text);")
    op.execute("DROP FUNCTION IF EXISTS public.list_conversations_for_user(integer);")
