...
/** Shared SVG icons (Heroicons-style) to replace emojis in UI. Use className for size/color (e.g. "w-5 h-5 text-gray-600"). */
interface IconProps {
  className?: string;
}
...
export function IconCheckDouble({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 11l4 4L19 5m-8 6l4 4 8-8" />
    </svg>
  );
}
...
export function IconEnvelope({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function IconPhoto({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
